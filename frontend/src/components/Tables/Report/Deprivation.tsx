...
import { getDeprivationReportedData } from '@/lib/utils';
...
const DeprivationTable = async (props: Props) => {
    const data = await getDeprivationReportedData(props);
                    ...
                    <Box sx={{ mt: 3 }}>
                        ...
                        <Table key={index}>
                            ...
                            <TableBody>
                                ...
                                <TableRow>
                                    <TableCellWithBorder align="center" colSpan={3}>คงเหลือ</TableCellWithBorder>
...
export default DeprivationTable
